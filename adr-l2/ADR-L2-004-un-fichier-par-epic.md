# ADR-L2-004 — Un fichier par épic

**Date** : 2026-06-08
**Statut** : Accepté
**Supersède** : ADR-L1-003 — Un fichier par épic (placé par erreur en L1)
...
Chaque épic est écrit dans son propre fichier, stocké dans le dossier `docs/epics/`.
