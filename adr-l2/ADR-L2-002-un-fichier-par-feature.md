# ADR-L2-002 — Un fichier par feature
...
Chaque feature est désormais écrite dans son propre fichier, stocké dans un sous-dossier de `docs/features/` correspondant à son épic parent.
